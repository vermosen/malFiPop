========================================================================
    ACTIVE TEMPLATE LIBRARY : malFiPopCom Project Overview
========================================================================

AppWizard has created this malFiPopCom project for you to use as the starting point for
...
malFiPopCom.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (malFiPopCom.h)
        GUID definitions                                (malFiPopCom_i.c)
        A type library                                  (malFiPopCom.tlb)
        Marshaling code                                 (malFiPopCom_p.c and dlldata.c)

malFiPopCom.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in malFiPopCom.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named malFiPopCom.pch and a precompiled types file named StdAfx.obj.
...
malFiPopComps.vcxproj
	...
	dlldata.c, malFiPopCom_i.c and malFiPopCom_p.c which are required
	to build the proxy/stub DLL.

malFiPopComps.vcxproj.filters
